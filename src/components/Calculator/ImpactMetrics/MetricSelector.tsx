    ...
    return (
        <>
            ...
            <button
                type="button"
                onClick={openModal}
                className="bg-[#ff0000] px-6 py-2 rounded-lg text-sm font-semibold border border-white text-white"
            >
                                ...
                                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className='overflow-y-auto h-[60vh] pr-2'>
                                        {searchMetrics.map((metric, index) => (
                                            <div className={`mt-2 border ${metric.isSelected ? "border-red-400 bg-red-50" : "border-gray-300"}   rounded-xl p-4`} key={index} onClick={() => handleSelect(metric)}>
                                                <div>
